# Licensing — nirs4all-aom

`nirs4all-aom` is part of the **nirs4all ecosystem** and is offered under a
...
for example, embedding `nirs4all-aom` in a **proprietary, closed-source product or SaaS**
...
`nirs4all-aom` relies on third-party open-source components. Their licenses are summarized
