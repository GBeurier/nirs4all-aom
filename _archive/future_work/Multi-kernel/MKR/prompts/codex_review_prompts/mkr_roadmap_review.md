...
```text
bench/aom_v0/Multi-kernel/MKR/docs/MKR_IMPLEMENTATION_PLAN.md
bench/aom_v0/Multi-kernel/MKR/docs/MKR_MATH_SPEC.md
bench/aom_v0/Multi-kernel/MKR/docs/MKR_TEST_PLAN.md
bench/aom_v0/Multi-kernel/MKR/docs/MKR_BENCHMARK_PROTOCOL.md
bench/aom_v0/Multi-kernel/MKR/aomridge/mkl.py
bench/aom_v0/Multi-kernel/MKR/aomridge/kernels.py
bench/aom_v0/Multi-kernel/MKR/aomridge/estimators.py
```
