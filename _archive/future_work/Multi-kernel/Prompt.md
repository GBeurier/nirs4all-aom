...
exécution un projet scientifique complet dans `bench/aom_v0/Multi-kernel` pour
...
`bench/aom_v0/Multi-kernel/aompls`.
...
À la fin, `bench/aom_v0/Multi-kernel` doit contenir :
...
```bash
PYTHONPATH=bench/aom_v0/Multi-kernel pytest bench/aom_v0/Multi-kernel/tests -q
...
PYTHONPATH=bench/aom_v0/Multi-kernel python bench/aom_v0/Multi-kernel/benchmarks/summarize_results.py \
  --results bench/aom_v0/Multi-kernel/benchmark_runs/smoke/results.csv \
...
```bash
PYTHONPATH=bench/aom_v0/Multi-kernel python -m compileall bench/aom_v0/Multi-kernel/aompls
PYTHONPATH=bench/aom_v0/Multi-kernel pytest bench/aom_v0/Multi-kernel/tests -q
PYTHONPATH=bench/aom_v0/Multi-kernel python bench/aom_v0/Multi-kernel/benchmarks/run_smoke_benchmark.py
```
