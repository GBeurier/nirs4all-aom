...
Scope:
- Work only in bench/aom_v0/Multi-kernel.
...
- bench/aom_v0/Multi-kernel/docs/AOMPLS_MATH_SPEC.md
- bench/aom_v0/Multi-kernel/docs/AOMPLS_OPERATOR_EXPLORATION.md
- bench/aom_v0/Multi-kernel/aompls/operators.py
- bench/aom_v0/Multi-kernel/aompls/banks.py
- bench/aom_v0/Multi-kernel/aompls/simpls.py
- bench/aom_v0/Multi-kernel/aompls/selection.py
- bench/aom_v0/Multi-kernel/aompls/estimators.py
- bench/aom_v0/Multi-kernel/tests/test_selection.py
- bench/aom_v0/Multi-kernel/tests/test_estimators.py
...
10. Run tests.
   At minimum run:
     pytest bench/aom_v0/Multi-kernel/tests/test_selection.py bench/aom_v0/Multi-kernel/tests/test_estimators.py -q
   If there are operator or SIMPLS changes, also run:
     pytest bench/aom_v0/Multi-kernel/tests/test_simpls.py bench/aom_v0/Multi-kernel/tests/test_operators.py -q
