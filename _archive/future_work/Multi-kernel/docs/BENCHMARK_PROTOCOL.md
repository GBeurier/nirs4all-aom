...
4. Record unavailable or unparsable datasets with `status="skipped"` and a
   reason.
5. Write `bench/aom_v0/Multi-kernel/benchmarks/cohort_regression.csv`.
...
```bash
PYTHONPATH=bench/aom_v0/Multi-kernel python bench/aom_v0/Multi-kernel/benchmarks/run_smoke_benchmark.py
```

Full regression:

```bash
PYTHONPATH=bench/aom_v0/Multi-kernel python bench/aom_v0/Multi-kernel/benchmarks/run_aompls_benchmark.py \
  --task regression \
  --cohort bench/aom_v0/Multi-kernel/benchmarks/cohort_regression.csv \
  --master bench/tabpfn_paper/master_results.csv \
  --workspace bench/aom_v0/Multi-kernel/benchmark_runs/regression_full \
  --seeds 0,1,2,3,4 \
  --n-jobs -1
```
...
PYTHONPATH=bench/aom_v0/Multi-kernel python bench/aom_v0/Multi-kernel/benchmarks/run_aompls_benchmark.py \
  ...
  --workspace bench/aom_v0/Multi-kernel/benchmark_runs/classification_full \
  --seeds 0,1,2,3,4 \
  --n-jobs -1
```
...
```bash
PYTHONPATH=bench/aom_v0/Multi-kernel python bench/aom_v0/Multi-kernel/benchmarks/summarize_results.py \
  --results bench/aom_v0/Multi-kernel/benchmark_runs/regression_full/results.csv \
  --master bench/tabpfn_paper/master_results.csv \
