...
`bench/aom_v0/Multi-kernel/aompls/` and is independent from the production `nirs4all`
library.
...
`bench/aom_v0/Multi-kernel/aompls/estimators.py` and `bench/aom_v0/Multi-kernel/aompls/classification.py`.
...
Defined in `bench/aom_v0/Multi-kernel/aompls/operators.py`. A spectral operator
...
All operators live in `bench/aom_v0/Multi-kernel/aompls/operators.py` and use **zero-padded
...
Defined in `bench/aom_v0/Multi-kernel/aompls/banks.py`. Every preset starts with the
...
`bench/aom_v0/Multi-kernel/aompls/preprocessing.py` and **must be applied as standalone
...
Defined in `bench/aom_v0/Multi-kernel/aompls/selection.py`. The dispatcher is
...
Defined in `bench/aom_v0/Multi-kernel/aompls/scorers.py` via `CriterionConfig`.
...
`bench/aom_v0/Multi-kernel/aompls/diagnostics.py`.
...
- `bench/aom_v0/Multi-kernel/docs/AOMPLS_MATH_SPEC.md` — formal mathematical specification.
- `bench/aom_v0/Multi-kernel/docs/AOMPLS_VALIDATION.md` — test inventory, mathematical equivalences, and benchmark evidence.
- `bench/aom_v0/Multi-kernel/docs/AOMPLS_IMPLEMENTATION_LOG.md` — phase-by-phase implementation notes.
- `bench/aom_v0/Multi-kernel/docs/BENCHMARK_PROTOCOL.md` — benchmark cohort and column schema.
