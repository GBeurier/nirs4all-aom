...
```bash
bash bench/aom_v0/Multi-kernel/publication/scripts/export_arxiv.sh
```

The script produces `bench/aom_v0/Multi-kernel/publication/arxiv/aompls_arxiv.zip`,
...
```bash
python bench/aom_v0/Multi-kernel/publication/scripts/make_figures.py
python bench/aom_v0/Multi-kernel/publication/scripts/make_tables.py
```
...
```bash
bash bench/aom_v0/Multi-kernel/publication/scripts/check_submission.sh
```
