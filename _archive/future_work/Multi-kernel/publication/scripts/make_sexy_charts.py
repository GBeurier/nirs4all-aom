...
- `bench/aom_v0/Multi-kernel/benchmark_runs/full/results.csv` (extended + parity benchmark).
- Optional `bench/tabpfn_paper/master_results.csv` for TabPFN-Raw / TabPFN-opt
  reference series.

Outputs into `bench/aom_v0/Multi-kernel/publication/figures/`.
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--results", default="bench/aom_v0/Multi-kernel/benchmark_runs/full/results.csv")
    parser.add_argument("--master", default="bench/tabpfn_paper/master_results.csv")
    parser.add_argument("--out", default="bench/aom_v0/Multi-kernel/publication/figures")
