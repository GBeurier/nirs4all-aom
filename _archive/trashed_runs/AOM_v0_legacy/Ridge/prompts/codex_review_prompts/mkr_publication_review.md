...
bench/AOM_v0/Ridge/publication/manuscript/main.tex (if extended for mkR)
bench/AOM_v0/Ridge/benchmark_runs/full/results.csv (mkR variants only)
bench/AOM_v0/Ridge/publication/figures/   (mkR-specific figures)
bench/AOM_v0/Ridge/publication/tables/    (mkR-specific tables)
```
