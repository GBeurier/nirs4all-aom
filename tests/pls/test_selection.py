...
from aom_nirs.pls.estimators import AOMPLSRegressor, POPPLSRegressor
from aom_nirs.pls.operators import IdentityOperator, SavitzkyGolayOperator
from aom_nirs.pls.scorers import CriterionConfig, cv_score_regression
from aom_nirs.pls.selection import select
from aom_nirs.pls.synthetic import make_regression
...
def test_holdout_scorer_runs(regression_data):
    ...
    from aom_nirs.pls.scorers import holdout_score_regression
