...
from aom_nirs.pls.nipals import nipals_adjoint
...
from aom_nirs.pls.simpls import simpls_covariance, superblock_simpls
from aom_nirs.pls.synthetic import make_regression
from aom_nirs.pls.torch_backend import (
