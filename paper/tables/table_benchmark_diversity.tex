...
Classification manifest & 17 included classification rows across the benchmark inventory. \\
...
Sample and wavelength range & Calibration sets span 28--39{,}225 samples and 125--4{,}200 spectral variables in the local regression manifest. \\
