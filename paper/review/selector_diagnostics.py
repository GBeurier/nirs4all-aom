...
The CLI writes:
  ...
  - ``paper/review/selector_diagnostics.csv``
  - ``paper/review/operator_frequency.csv``
  - ``paper/review/compact_bank_justification.md``
  - ``paper/tables/table_selector_diagnostics.tex``

Usage::

    python paper/review/selector_diagnostics.py \
        --aompls _archive/trashed_runs/AOM_v0_legacy/benchmark_runs/full/results.csv \
        --aomridge benchmarks/runs/ridge/paper_aom_aomridge_seeds012/results.csv \
        --out paper/review/
"""
...
# ``_archive/trashed_runs/AOM_v0_legacy/benchmark_runs/full/results.csv``).
...
def write_compact_bank_justification_md(
    ...
    lines.append(
        "Auto-generated by `paper/review/selector_diagnostics.py`. "
        "Do not edit by hand; re-run the script after new benchmark seeds.\n",
    )

    lines.append("## Compact bank contents\n")
    lines.append("Compact bank order (matches `<external: nirs4all/bench/AOM_lib (archived at aom_nirs/_archive/multi_lang/AOM_lib)>` and the AOM_v0 reference):\n")
...
def write_selector_diagnostics_tex(
    ...
    lines: list[str] = []
    lines.append("% Auto-generated by paper/review/selector_diagnostics.py")
...
def _build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--aompls",
        type=Path,
        default=Path("_archive/trashed_runs/AOM_v0_legacy/benchmark_runs/full/results.csv"),
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "benchmarks/runs/ridge/paper_aom_aomridge_seeds012/results.csv",
        ),
