...
| `reproduce.sh reviewer-controls` | Regenerate the real-spectrum figure, standard RPD table, HPO audits, matched PLS-DA rerun, four-task timing check and full N=32 compact-bank folded/materialised control at 5 and 3 folds | Yes; CPU-only, at most five workers |
...
paths. The full control covers 32 tasks, three seeds and both five- and three-fold protocols. These
controls disable GPUs, cap numerical-library threads, and use at most five CPU workers,
